...
public class Barra implements ElementoUI, Identificable {
    ...
    private BarraOrientacion orientacion;
    ...
    public void setValorPorDiferencial(BigDecimal d) {
        ...
        if (orientacion == BarraOrientacion.VERTICAL) {
            ...
            wBar = wMax;
        } else if (orientacion == BarraOrientacion.HORIZONTAL) {
            hBar = hMax;
        ...
        c = sketch.lerpColor(cIni, cFin, PApplet.map(valor.floatValue(), valorMin.floatValue(), valorMax.floatValue(), 0, 1));
    }
    ...
    public void setRango(BigDecimal valorMin, BigDecimal valorMax) {
        this.valorMin = new BigDecimal(valorMin.toString());
        this.valorMax = new BigDecimal(valorMax.toString());
        valor = new BigDecimal(valorMin.toString());
    }
    ...
    public BarraOrientacion getOrientacion() {
        return orientacion;
    }

    public void setOrientacion(BarraOrientacion orientacion) {
